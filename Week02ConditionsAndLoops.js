 ...
 * ↓ YOUR CODE HERE ↓ */
   let studentClass;
   let studentGrade = prompt('Grade');

   if(studentGrade >= 0 && studentGrade <=6) {
      studentClass = 'Elementary';
      console.log('Your student class is ' + studentClass);
   ...
   //Another Solution:
   //Can remove the console.log from each if statement and place 1 at the end of the statements instead
   //however, if it reaches the last error, it will result in 'Error undefined'
   //It's because we didn't define the varible so since the console.log is outside of the loop, it
   //will not take any value
   //Check solution video or the code given to understand this
 ...
 * ↓ YOUR CODE HERE ↓ */
   //Step 1
   // i = 10 is the starting place (starts at 10)
   // i>= -10 is the stoping place (ends at -10)
   //i-- is the incrementor (or decrease in this situation)
   console.log("Step 1");
   for(var i = 10; i >= -10; i--) {
         console.log(i);
   }
